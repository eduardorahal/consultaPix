            ...
            <Grid container spacing={2}>
                <Grid item xs={2} md={2}>
                    <FormControl style={{ verticalAlign: 'middle', marginInline: 20 }}>
                        ...
                        >
                            <FormControlLabel id="cpf_cnpj" value="cpfCnpj" control={<Radio size='small' style={{ margin: 0, alignItems: 'center', padding: 5 }} />} label={<div style={{ fontSize: 14 }}>Por CPF/CNPJ</div>} />
                            <FormControlLabel value="chave" control={<Radio size='small' style={{ margin: 0, alignItems: 'center', padding: 5 }} />} label={<div style={{ fontSize: 14 }}>Por Chave PIX</div>} />
                        </RadioGroup>
                    </FormControl>
                </Grid>
